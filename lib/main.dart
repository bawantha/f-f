...
import 'package:travel_sl/login_page/login_page_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<TravelSlFirebaseUser> userStream;
  TravelSlFirebaseUser initialUser;

  @override
  void initState() {
    super.initState();
    userStream = travelSlFirebaseUserStream()
